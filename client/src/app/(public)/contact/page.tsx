            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">Rruga Pjetër Bogdani<br />Tirana, Albania</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">info@bottlebrothers.al</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 pt-8 border-t border-neutral-200">
                <h3 className="font-semibold text-neutral-900 mb-4">Operating Hours</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Tuesday - Thursday</span>
                    <span className="font-semibold text-neutral-900">5:00 PM - 12:00 AM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Friday - Saturday</span>
                    <span className="font-semibold text-neutral-900">5:00 PM - 2:00 AM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Sunday</span>
                    <span className="font-semibold text-neutral-900">5:00 PM - 11:00 PM</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="mt-8 pt-8 border-t border-neutral-200">
                ...
                <div className="flex gap-3">
                  <a href="#" className="p-3 bg-neutral-100 hover:bg-primary-100 rounded-lg transition-colors">
