...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-green-200 border-t border-green-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          
          {/* Brand & Description */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-800">Lounge</h3>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <Link to="/menu" className="text-gray-700 hover:text-gray-900 transition-colors text-sm">
                Menu
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-start space-x-2">
                ...
                <span>123 Lounge Street<br/>City, State 12345</span>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <Link to="/contact">
                <button className="bg-gray-800 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-700 transition-colors w-full">
                  Make Reservation
                </button>
              </Link>
            </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-green-300 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-gray-700">
            © 2024 Lounge. All rights reserved.
          </div>
